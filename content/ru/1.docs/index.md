...
#features
  ...
  #description
  Mettez à jour les couleurs, les liens sociaux, les logos ou même le style de vos composants globalement via le `app.config2.ts2`, sans modification directe du code.
  :::
